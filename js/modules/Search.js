...
class Search {
    ...
    typingLogic(){
      ...
      getResults(){
          $.getJSON(universityData.root_url +'/wp-json/university/v1/search?tern=' + this.searchField.val(), (results) => {
        this.resultsDiv.html(`
            <div class="row">
              <div class="one-third"
              ...
              ${results.campuses.length ? '<ul class="link-list min-list">' : '<p>No general information</p>'}
